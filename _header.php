...
<head>
    ...
    <link rel="icon" href="<?=base_url('_assets/rumah-sakit.png')?>">
    <!-- Bootstrap Core CSS -->
	...
	<div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <!-- <li class="dropdown">
                    <a href="#dropdown-menu" class="dropdown-toggle" data-toggle="dropdown">Data <b class="caret"></b></a>
                    <ul class="dropdown-menu"  id="dropdown-menu">
                        ...
                        <li><a href="<?= base_url('supplier/data.php') ?>">Data Supplier</a></li>
                    </ul>
                </li> -->
                <?php
                ...
                <?php }elseif($level  == '2'){?>
                <li>
                    <a href="<?= base_url('rekammedis_/data.php') ?>">Rekam Medis</a>
                </li>
                <?php }?>
                <li>
